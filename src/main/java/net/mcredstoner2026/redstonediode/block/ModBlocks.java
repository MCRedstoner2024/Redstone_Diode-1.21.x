...
public class ModBlocks {
    ...
    public static final Block REDSTONE_DIODE = registerBlock("redstone_diode",
            properties -> new RedstoneDiodeBlock(properties
                    .breakInstantly()
    ...
    private static Block registerBlock(String name, Function<AbstractBlock.Settings, Block> function) {
        Block toRegister = function.apply(AbstractBlock.Settings.create().registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(RedstoneDiode.MOD_ID, name))));
    ...
    private static void registerBlockItem(String name, Block block) {
        Registry.register(Registries.ITEM, Identifier.of(RedstoneDiode.MOD_ID, name),
                new BlockItem(block, new Item.Settings().useBlockPrefixedTranslationKey()
                        .registryKey(RegistryKey.of(RegistryKeys.ITEM, Identifier.of(RedstoneDiode.MOD_ID, name)))));
    }
